Buat file baru.
Buat struktur dasar HTML (boilerplate) dengan <!DOCTYPE html>, <html>, <head>, dan <body>. Pastikan di dalam <head> ada meta charset dan viewport, serta <title> yang sesuai.
...
<article>
    ...
    <figure>
        <img src="OIP.jpeg" alt="Gambar hidangan utama resep" width="600">
        <figcaption>Deskripsi singkat atau caption untuk gambar.</figcaption>
    </figure>
    ...
    <h3>Video Tutorial</h3>
    <video controls width="600">
        <source src="nasgor goreng.mp4" type="video/mp4">
        Maaf, browser Anda tidak mendukung pemutaran video.
        <track
            label="Bahasa Indonesia"
            kind="subtitles"
